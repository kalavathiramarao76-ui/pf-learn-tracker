  ...
  return (
    <html lang="en" className={theme}>
      <Head>
        ...
        <meta name="twitter:description" content="Take the first step towards unlocking your potential with our personalized learning pathways. Explore our expert-led courses, adaptive assessments, and supportive community to achieve your goals." />
